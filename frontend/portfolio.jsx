            ...
            <main className="main-content">
                ...
                <section id="home" className="section hero-section">
                    <div className="grid-2">
                        ...
                        <div className="hero-text">
                            ...
                            <h1>
                                Hi, I'm <span className="highlight" style={{color: 'var(--accent-teal)'}}>Jari Mol</span>
                            ...
                            <div className="social-links">
                                <a href="https://github.com/Jarizeelst" target="_blank" rel="noopener noreferrer">
                                    <Github size={24} />
                                </a>
                                <a href="https://www.linkedin.com/in/jari-mol" target="_blank" rel="noopener noreferrer">
                                    <Linkedin size={24} />
                                </a>
                            </div>
                        </div>
                ...
                <section id="skills" className="section">
                    ...
                    <div className="languages-section">
                        ...
                        {/* Reusing grid-2 here ensures languages align perfectly with the split above */}
                        <div className="grid-2">
                ...
                {/* Experience & Education - 50/50 Split */}
                <div className="grid-2">
                    {/* Left Column */}
                    <section id="experience">
                        <h2 className="section-title"><Briefcase color="#22d3ee" /> History</h2>
                        <div className="timeline">
                            <TimelineItem
                                date="Jan 2023 — Present"
                                title="Evening Operations"
                                subtitle="Seabourne Logistics"
                    ...
                    <section id="education">
                        <h2 className="section-title"><GraduationCap color="#14b8a6" /> Education</h2>
                        <div className="timeline">
                            <TimelineItem
                                date="Aug 2022 — Present"
                                title="SintLucas"
                                subtitle="Web Development"
                                description="Currently engaged in full-stack web development studies."
                                current
                            />
                            <TimelineItem
                                ...
                                description="Successfully completed secondary education with a focus on exact sciences."
                            />
                        </div>
                    </section>
                </div>
